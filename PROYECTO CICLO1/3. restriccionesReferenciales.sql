...
--AccionesOk
--CRUD: Personas
insert into Personas (id, nombre, apellido, telefono, direccion, fechaDeNacimiento) values (10000000, 'Steven', 'Stainbridge', '3876808419', '961 Corry Junction', '20/05/1982');
SELECT * FROM Personas WHERE id BETWEEN '10000195' AND '10000200';
DELETE FROM Personas WHERE id = 10000200;
SELECT * FROM Personas WHERE id BETWEEN '10000195' AND '10000200';
--
...
insert into Personas (id, nombre, apellido, telefono, direccion, fechaDeNacimiento) values (10000032, 'Raymund', 'Tettley', '3887876855', '1459 Delladonna Drive', '16/09/2022');
...
--DisparadoresNoOk
UPDATE Perecederos SET precio = 999999999 WHERE id = 10000099;
DELETE Perecederos WHERE id = 10000093;
DELETE NoPerecederos WHERE id = 10001099;
